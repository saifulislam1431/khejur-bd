...
const Main = () => {
    return (
        <section>
            <Navbar />
            <div className="fixed bottom-0 right-0 m-8 z-50 border border-primary rounded-3xl text-primary hover:bg-primary hover:text-white transition-all duration-500 animate-pulse">
